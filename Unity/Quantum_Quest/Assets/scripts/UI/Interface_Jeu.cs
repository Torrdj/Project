...
public class Interface_Jeu : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        //bar button
        Bar.rectTransform.sizeDelta = new Vector2(522, 54);
        Bar.transform.position = new Vector2(Screen.width / 2, 27);
        //menu_image
        ...
        {
            if (GUI.Button(new Rect(Screen.width / 2 - 261 + (i + 1) * 2 + i * (50), Screen.height - 52, 50, 50), "") && Game) // ajouter GUIStyle des button
            {
